        ...
        <div className='w-full mb-5 '>
            <div className='max-w-[90%] mx-auto flex h-[40vh] flex-wrap justify-around px-5'>
                <div className='flex flex-col md:w-[50%] w-full'>
                    <div>
                        <h1 className='text-[40px]'>Great futures are built with a small trust</h1>
                    </div>
                    <div className='pt-5'>
                        <p className='text-[18px]'>Lorem ipsum dolor sit amet consectetur. At consequat purus hendrerit proin risus Sit purus ante dictum in malesuada id.Lorem   </p>
                    </div>
